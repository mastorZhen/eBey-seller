...
===============================================================================
	...
	2. document/
		...
		2.4 Wireless_tools_porting_guide.pdf
		2.5 HowTo_enable_driver_to_support_WIFI_certification_test.pdf
		2.6 HowTo_enable_the_power_saving_functionality.pdf
		2.7 Quick_Start_Guide_for_SoftAP.pdf
		2.8 SoftAP_Mode_features.pdf
		2.9 linux_dhcp_server_notes.txt
		2.10 Quick_Start_Guide_for_Bridge.pdf
		2.11 RTK_P2P_WFD_Programming_guide.pdf
		2.12 HowTo_enable_driver_to_support_80211d.pdf
		2.13 Realtek_WiFi_concurrent_mode_Introduction.pdf
		2.14 Miracast_for_Realtek_WiFi.doc
		2.15 HowTo_debug_BT_coexistence.pdf

	3. driver/
		3.1 rtl8812AU_linux_v4.2.4_9390.20131023.tar.gz
	...
	4. wpa_supplicant_hostapd/
		...
		4.5 wpa_supplicant_8_jb_4.1_rtw_r7473.20130517.tar.gz
		...
		4.6 wpa_supplicant_8_jb_4.2_rtw_r8680.20130821.tar.gz
 		...
 		4.7 wpa_supplicant_8_jb_4.3_rtw_r9301.20131011.tar.gz
	...
	11. android_ref_codes_JB_4.3
		11.1 linux-3.0.42_STATION_INFO_ASSOC_REQ_IES.diff
			Kernel patch file for config80211's STATION_INFO_ASSOC_REQ_IES event for kernel 3.0.

		11.2 realtek_wifi_SDK_for_android_JB_4.3_20131011.tar.gz
			This tar ball includes our android wifi reference codes for Android 4.3

		11.3 Realtek_Wi-Fi_SDK_for_Android_JB_4.3.pdf
			Guide for porting Realtek wifi onto your Android 4.3 system
...
==================================================================================================================
			...
			(*) For Android 4.3, please refer to android_ref_codes_JB_4.3/Realtek_Wi-Fi_SDK_for_Android_JB_4.3.pdf